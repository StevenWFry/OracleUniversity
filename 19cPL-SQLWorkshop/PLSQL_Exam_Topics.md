## Oracle Database 19c: PL/SQL Certification Exam Topics (Review Sheet)

This document summarizes the core PL/SQL exam topics and how they map to the lessons in this workshop. Use it as a quick checklist when revising.
...
- Use `NOCOPY` hint, `PARALLEL_ENABLE` hint, and `DETERMINISTIC` clause.
...
- Implement code-based access control: granting roles to program units.
