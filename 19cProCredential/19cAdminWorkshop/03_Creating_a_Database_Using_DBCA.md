...
And look, you *can* build an Oracle database entirely by hand with a parameter file, `STARTUP NOMOUNT`, and a several‑screen `CREATE DATABASE` command. You can also churn your own butter. DBCA exists so you do not have to.
...
- Decide directory / disk‑group naming conventions
- Decide where Oracle‑managed files (OMF) should live
