# Module 1 – Oracle Database Creation and Administration (Architecture Speed‑Run)
...
- **Pluggable Databases (PDBs)** – where the actual application data lives
  ...
  - Created from a **PDB seed** (a template), then customised  
...
## 3. Single‑Instance vs Multi‑Instance (RAC)
